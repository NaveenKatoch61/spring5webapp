...
@Component
public class LifeCycleDemoBean2 implements InitializingBean, DisposableBean, BeanNameAware,
...
public BookBean getObj() {
		return obj;
	}


	public void setObj(BookBean obj) {
		this.obj = obj;
	}
